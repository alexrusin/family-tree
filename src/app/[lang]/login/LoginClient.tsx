      ...
      <section className="w-full md:w-1/2 flex items-center justify-center px-6 py-10 md:p-16">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={onSubmit} className="space-y-5" noValidate>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <Link href={forgotPasswordHref} className="text-label-sm text-primary hover:underline transition-all">
                  {t.forgotPassword}
                </Link>
              </div>
              <input
          ...
          <div className="mt-8 pt-6 border-t border-stone-200 text-sm text-on-surface-variant">
            {t.noAccount}{' '}
            <Link href={signupHref} className="text-primary font-semibold hover:underline">{t.signupLink}</Link>
          </div>
        </div>
      </section>
    </main>
